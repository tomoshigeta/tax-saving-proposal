...
def build() -> None:
    ...
    lines = [
        ...
        ("9. 「登記費用」は登録免許税と司法書士報酬の合計です。初年度の経費として計算に入ります。空欄なら 0 です。", False),
        ("10. 「試算期間(年)」は節税効果を合計する年数です(1〜35)。空欄なら 15 年です。", False),
        ("11. 写真はExcelでは扱いません。取り込んだあと、アプリの入力画面で1枚だけ追加してください。", False),
        ("", False),
