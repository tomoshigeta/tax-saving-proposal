    ...
    <div className="help">
      ...
      <article className="help-body">
          ...
          <dl className="help-defs">
            ...
            <div>
              ...
              <dd>
                ...
                1枚目の「3年間の節税効果 合計」と節税額グラフの横軸が3年分になります
                (ローン残債のグラフと2枚目の年次明細は返済期間の全期間のままです)。
              </dd>
            </div>
            <div>
              <dt>写真</dt>
        ...
        <section>
          ...
          <ul>
            <li>
              ファイル名は<strong>「顧客名様物件名節税シミュレーション」</strong>が自動で入ります
              (顧客名が空なら物件名から)。保存の画面で変えることもできます
            </li>
            <li>1枚目はA4ちょうどに収まります</li>
            <li>
              2枚目には、ローン完済までの年ごとの内訳(賃料収入・減価償却費・支払利息・不動産所得・
              通算可能な赤字・残債)と「計算の根拠」(月々のキャッシュフローの内訳、価格の按分と耐用年数)が付きます。
        ...
        <section>
          ...
          <ul className="help-assumptions">
            <li>
              ...
              節税額のグラフと節税効果 合計はこの年数で集計します。
              <strong>ローン残債のグラフと2枚目の年次明細は返済期間の全期間</strong>で、残債が0になるまで載ります
            </li>
            <li>
